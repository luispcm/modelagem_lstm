...
| Ajuste do LSTM | lag | RMSE | $$ 
                                R^2 
                                $$ | MAE |
|:----------------------------:|:------------:|:------------:|:------------:|::|
| **Ajuste 1** | 1 | 40,2737 | 0,1481 | 32,4104 |
| **Ajuste 2** | 2 | 37,2511 | 0,3246 | 30,1603 |
| **Ajuste 3** | 3 | 37,2921 | 0,2981 | 30,4152 |
| **Ajuste 4** | **7** | **33,2105** | **0,4340** | **26,4082** |
