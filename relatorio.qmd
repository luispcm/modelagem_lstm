...
\textcolor{red}{cotinuar a partir daqui com base no primeiro parágrafo de "Step-by-Step LSTM Walk Through" do site de base}



# Resultados

\textcolor{red}{lembre-se de falar sobre a base de dados no fim da seção anterior}
